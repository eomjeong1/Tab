...
public class BattleScene : MonoBehaviour
{
    ...
    void Start()
    {
        var monster = TabBattleManager.GetInstance().GetRandomMonster();
        // monster.gameObject.SetActive(true);
        GameObject go = ObjectManager.GetInstance().CreateMonster(monster.monsterName); // 몬스터 생성함수를 오브젝트매니저에서 갖고 와서 변수로 선언해줄거야
        ...
        TabBattleManager.GetInstance().BattleStart(monster);
